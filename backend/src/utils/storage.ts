 ...
 * - Biconomy: Gateway provider - also constrained by same policy
 */
...
/**
 * Biconomy (Gateway) signer config - stored securely on our backend
 * Used by the Gateway to sign requests on behalf of operators
 */
